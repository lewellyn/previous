...
#define DLGMA_CHECK         36
#define DLGMA_EXIT          37
...
{
    { SGBOX, 0, 0, 0,0, 63,22, NULL },
    { SGTEXT, 0, 0, 22,1, 14,1, "Custom memory setup" },
    
    { SGBOX, 0, 0, 2,4, 14,10, NULL },
    { SGTEXT, 0, 0, 3,5, 14,1, "Bank0" },
    { SGRADIOBUT, 0, 0, 4,7, 7,1, "2 MB" },
    { SGRADIOBUT, 0, 0, 4,8, 7,1, "4 MB" },
    { SGRADIOBUT, 0, 0, 4,9, 7,1, "8 MB" },
    { SGRADIOBUT, 0, 0, 4,10, 7,1, "16 MB" },
    { SGRADIOBUT, 0, 0, 4,11, 7,1, "32 MB" },
    { SGRADIOBUT, 0, 0, 4,12, 7,1, "none" },
    
    { SGBOX, 0, 0, 17,4, 14,10, NULL },
    { SGTEXT, 0, 0, 18,5, 14,1, "Bank1" },
    { SGRADIOBUT, 0, 0, 19,7, 7,1, "2 MB" },
    { SGRADIOBUT, 0, 0, 19,8, 7,1, "4 MB" },
    { SGRADIOBUT, 0, 0, 19,9, 7,1, "8 MB" },
    { SGRADIOBUT, 0, 0, 19,10, 7,1, "16 MB" },
    { SGRADIOBUT, 0, 0, 19,11, 7,1, "32 MB" },
    { SGRADIOBUT, 0, 0, 19,12, 7,1, "none" },
    
    { SGBOX, 0, 0, 32,4, 14,10, NULL },
    { SGTEXT, 0, 0, 33,5, 14,1, "Bank2" },
    { SGRADIOBUT, 0, 0, 34,7, 7,1, "2 MB" },
    { SGRADIOBUT, 0, 0, 34,8, 7,1, "4 MB" },
    { SGRADIOBUT, 0, 0, 34,9, 7,1, "8 MB" },
    { SGRADIOBUT, 0, 0, 34,10, 7,1, "16 MB" },
    { SGRADIOBUT, 0, 0, 34,11, 7,1, "32 MB" },
    { SGRADIOBUT, 0, 0, 34,12, 7,1, "none" },
    
    { SGBOX, 0, 0, 47,4, 14,10, NULL },
    { SGTEXT, 0, 0, 48,5, 14,1, "Bank3" },
    { SGRADIOBUT, 0, 0, 49,7, 7,1, "2 MB" },
    { SGRADIOBUT, 0, 0, 49,8, 7,1, "4 MB" },
    { SGRADIOBUT, 0, 0, 49,9, 7,1, "8 MB" },
    { SGRADIOBUT, 0, 0, 49,10, 7,1, "16 MB" },
    { SGRADIOBUT, 0, 0, 49,11, 7,1, "32 MB" },
    { SGRADIOBUT, 0, 0, 49,12, 7,1, "none" },
    
    { SGTEXT, 0, 0, 3,15, 14,1, "Some values are only invalid valid on certain machines." },
    { SGTEXT, 0, 0, 3,16, 14,1, "They will be corrected automatically." },

    { SGBUTTON, 0, 0, 20,19, 9,1, "Check" },
    { SGBUTTON, SG_DEFAULT, 0, 35,19, 8,1, "OK" },
    { -1, 0, 0, 0,0, 0,0, NULL }
};
...
void Dialog_MemAdvancedDlgDraw(int *bank) {
    ...
    for (i = 0; i<4; i++) {
        ...
        for (j = (DLGMA_BANK0_2MB+(8*i)); j <= (DLGMA_BANK0_32MB+(8*i)); j++)
        {
...
void Dialog_MemAdvancedDlgRead(int *bank) {
    int i, j;
    for (i = 0; i<4; i++) {
        for (j = (DLGMA_BANK0_2MB+(i*8)); j<=(DLGMA_BANK0_32MB+(i*8)); j++) {
